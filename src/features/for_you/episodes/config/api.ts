...
export const ENDPOINTS = {
  ...
  REWARDS: {
    ...
    SUBSCRIPTION_PLANS: '/rewards/subscription/subscriptionlist',
    VIP_PLANS: '/rewards/subscription/subscriptionlist',
    SUBSCRIPTION_PURCHASE: '/rewards/confirm-payment/plan-purchase',
    SUBSCRIPTION_STATUS: '/rewards/recharge/update/recharge-status',
    CURRENT_SUBSCRIPTION: '/rewards/subscription/current',
