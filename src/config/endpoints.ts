...
export const endpoints = {
  ...
  rewards: {
    ...
    BENEFITS: `${BASE_URL}/rewards/benefits`,
    SUBSCRIPTION_PLANS: `${BASE_URL}/rewards/subscription/subscriptionlist`,
    VIP_PLANS: `${BASE_URL}/rewards/subscription/subscriptionlist`,
    RECHARGE_LIST: `${BASE_URL}/rewards/rechargeList`,
    CREATE_RECHARGE: `${BASE_URL}/rewards/recharge/create`,
    RECHARGE_HISTORY: `${BASE_URL}/rewards/rechargeHistory`,
    REWARD_HISTORY: `${BASE_URL}/rewards/rewardHistory`,
    ADS_COUNT: `${BASE_URL}/rewards/adRewards/adsCount`,
    UPDATE_AD_STATUS: `${BASE_URL}/rewards/updateAdStatus`,
    UNLOCK_COINS: `${BASE_URL}/rewards/unlockEpisodeCoins`,
    UNLOCK_ADS: `${BASE_URL}/rewards/unlockEpisodeAds`,
    UNLOCKED_EPISODES: `${BASE_URL}/rewards/unlockedEpisodes`,
    GET_UNLOCKED_EPISODE: `${BASE_URL}/rewards/unlockedEpisodes`,
    SUBSCRIPTION_PURCHASE: `${BASE_URL}/rewards/confirm-payment/plan-purchase`,
    SUBSCRIPTION_STATUS: `${BASE_URL}/rewards/recharge/update/recharge-status`,
  },
  upload: {
